                              ...
                              <div className="container mx-auto max-w-4xl">
                                          ...
                                          <div className="flex justify-between items-center">
                                                <div className="text-white uppercase flex flex-col items-start">
                                                      <h1 className="text-3xl font-extrabold tracking-wider">
                                                            <Link >Abhishek Lode</Link>
                                                      </h1>
                                                      <h3 className="text-2xl mt-1">Electrician</h3>
                                                </div>
                                                <div className="text-right flex flex-col items-end">
                                                      <p className="text-lg text-white flex items-center gap-1">
                                                            <a href="https://wa.me/917262093674" className="flex items-center gap-1">
                                                                  <PiPhoneCallDuotone /><span className="hover:underline">+91 7262093674</span>
                                                            </a>
                                                      </p>
                                                      <p className="text-lg text-white flex items-center gap-1">
                                                            <a href="mailto:abhisheklode680@gmail.com" className="hover:underline flex items-center gap-1">
                                                                  <MdOutlineMailOutline /> abhisheklode680@gmail.com
                                                            </a>
                                                      </p>
                                    ...
                                    <div className="bg-gray-100 dark:bg-gray-800 shadow-sm p-4 rounded-md mb-4">
                                          ...
                                          <div className="space-y-3">
                                                <div className="flex items-center space-x-2">
                                                      ...
                                                      <p className="text-lg text-gray-700 dark:text-gray-300">10th SSC - Vanita Vikash Vidyalaya (2018)</p>
                                                </div>
                                                {/* <div className="flex items-center space-x-2">
                                                      <GiGraduateCap size="28px" />
                                    ...
                                    <div className="bg-gray-100 dark:bg-gray-800 shadow-sm p-4 rounded-md ">
                                          ...
                                          <ul className="text-lg text-gray-700 dark:text-gray-300 space-y-1">
                                                <li><strong>Name:</strong> Abhishek Vitthal Lode</li>
                                                <li><strong>Date of Birth:</strong> 20 May 2003</li>
                                                <li><strong>Languages:</strong> Marathi, Hindi</li>
                                                <li><strong>Marital Status:</strong> Unmarried</li>
                                                <li><strong>Caste:</strong> OBC (Teli)</li>
                                          </ul>
                                    </div>
